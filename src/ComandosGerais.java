...
/**
 * Enum ComandosGerais - Esse enum define e fornece os comandos da
 * bancada.<br/>
 *
 * <br/>
 * Modificado do jogo "World of Zuul": um jogo de aventura muito simples,
 * baseado em texto.<br/>
 *
 * <br/>
 * (Originalmente uma classe do codigo do jogo "World of Zuul" chamada
 * PalavrasComando
 * que foi transformada para um Enum por questoes de padronizacao e por se
 * tratar de um conjunto
 * fixo de elementos).<br/>
 * <br/>
 * Esse enum guarda uma enumeracao de todos os comandos gerais do jogo, ou seja,
 * aqueles que sao
 * reconhecidos em qualquer ambiente do jogo. Ele eh usada no reconhecimento de
 * comandos como
 * eles sao digitados.
 *
